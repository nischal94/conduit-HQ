...
| §7 — policies persist across source refresh; manual overrides never silently reverted | — | ⏳ awaits storage layer |
| §9.2 — secrets encrypted at rest (master key) | — | ⏳ awaits storage layer |
